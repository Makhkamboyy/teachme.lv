<template>
  ...
  <div class="container sign-up-form" @submit.prevent="auth">
    <form class="col-6">
      <div
          v-if="errorForForm"
      ...
      >
        ...
        <strong>Error !</strong> Check your password or email !
      ...
      <div class="warn-form">
        <p>Need an account? <router-link to="/register">Sign in here</router-link> </p>
      </div>
    </form>
  </div>
